...
window.onload = ()=> {
	...
	let iconNames = ["cut", "copy", "paste", "select-all", "delete", "save", "undo", "redo", "speak", "open-as-window", "night-mode", "help", "info", "keyboard"];
	...
	document.getElementById("open-as-window").title = "Open As New Window";
	document.getElementById("night-mode").title = "Night Mode";

	document.getElementById("versionPara").innerHTML = "Version " + chrome.runtime.getManifest().version;
